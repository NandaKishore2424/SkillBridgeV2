...
export function TrainerBulkUploadPage() {
    ...
    const handleDownloadTemplate = async () => {
        try {
            const blob = await downloadTrainerTemplate()
            const url = window.URL.createObjectURL(blob)
            const a = document.createElement('a')
            a.href = url
            a.download = 'trainer_template.csv'
                ...
                <PageWrapper>
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight">Bulk Upload Trainers</h1>
                                <p className="text-muted-foreground">
                                    Upload CSV file to add multiple trainers at once
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Select a CSV file containing trainer details.
                                    </CardDescription>
                                </CardHeader>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <ul className="list-disc pl-4 space-y-2 text-sm text-muted-foreground">
                                        ...
                                        <li>Fill in the details: Full Name, Email are mandatory.</li>
                                        <li>Ensure emails are unique.</li>
