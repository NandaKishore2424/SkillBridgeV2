...
/**
 * The people who run a batch: the trainer teaching it and the admin who owns it.
 *
 * <p>Carries {@literal @}PreAuthorize("hasAnyRole('TRAINER', 'COLLEGE_ADMIN')"). Naming the rule keeps it
...
public @interface TrainerOrCollegeAdmin {
}
