...
/**
 * One college's administrator: its students, trainers, batches and imports.
 *
 * <p>Carries {@literal @}PreAuthorize("hasRole('COLLEGE_ADMIN')"). Naming the rule keeps it
...
public @interface CollegeAdminOnly {
}
