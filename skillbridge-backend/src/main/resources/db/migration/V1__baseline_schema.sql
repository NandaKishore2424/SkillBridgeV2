-- =============================================================================
-- V1: the SkillBridge schema as it stood when Flyway was reinstated (2026-09-19)
--
-- Generated from db/schema/baseline.sql, the pg_catalog capture of the Supabase
-- database that was verified identical to live (fingerprint 622 objects,
-- 4a9095e3aa02771c7eb23690897fe40d). One difference, on purpose: the legacy
-- `flyway_schema_history` table is left out. It recorded migrations deleted on
-- 2026-09-05, and Flyway creates its own history table before running this file.
--
-- NEVER EDIT THIS FILE. Flyway checksums applied migrations and refuses to start
-- if one changes. Every schema change is a new V<n>__<what>.sql.
-- =============================================================================
...
--     over.
--
--   * The legacy flyway_schema_history table that baseline.sql reproduces is
--     omitted here (see the header). The table of that name in a database built
--     from these migrations is Flyway's own.
-- -----------------------------------------------------------------------------
